...
<div class="container-fluid">
    ...
    <header>
        <img src="img/img1.jpg" alt="" srcset="" id="zd1">
        <img src="img/img2.jpg" alt="" srcset="" id="zd2">
        <img src="img/img3.jpg" alt="" srcset="" id="zd3">
        <h1 id="qw1">Lorem, ipsum dolor.</h1>
        <h1 id="qw2">Lorem, ipsum dolor.</h1>
        <h1 id="qw3">Lorem, ipsum dolor.</h1>
